    ...
    <Box>
      ...
      >
        <Box>
          ...
          <Typography variant="body2" color="text.secondary">
            Set the prices for your client's trip
          </Typography>
        </Box>
        <Button
      ...
      >
        ...
        <Grid
          container
          spacing={2}
          sx={{ mb: 2, px: 1, display: { xs: "none", md: "flex" } }}
        >
          <Grid item md={5}>
            ...
            >
              ...
              <Grid
                ...
                sx={{
                  textAlign: "right",
                  mt: { xs: 1, md: 0 },
                  pt: { xs: "26px !important", md: "16px !important" },
                }}
              >
                <IconButton
            ...
            <Grid container spacing={2}>
              ...
              <Grid item xs={12} sm={6}>
                ...
                <TextField
                  ...
                  size="small"
                  type="number"
                  value={priceData.taxes.serviceTax}
                  onChange={(e) =>
                    handleTaxChange("serviceTax", e.target.value)
                  }
                  sx={{ bgcolor: "#f5f7fa", "& fieldset": { border: "none" } }}
                />
              </Grid>
            ...
            <Grid container spacing={2}>
              ...
              <Grid item xs={12} sm={6}>
                ...
                <TextField
                  ...
                  size="small"
                  type="number"
                  value={priceData.discount.value}
                  onChange={(e) =>
      ...
      >
        ...
        >
          <Typography variant="h6" fontWeight="700" mb={2} color="#0d47a1">
            Summary
          </Typography>
          ...
          >
            <Typography color="text.secondary" fontWeight="500">
              Service Tax ({priceData.taxes.serviceTax}%)
            </Typography>
            <Typography fontWeight="700" color="#1a1a1a">
