          ...
          {Array.from({ length: Number(formData.children) || 0 }).map((_, index) => (
            <Grid item xs={12} md={4} key={index}>
              ...
              <TextField select fullWidth size="small" value={formData.childAges[index] || ''} onChange={(e) => handleChildAgeChange(index, e.target.value)}>
                ...
                <MenuItem value="2">2</MenuItem><MenuItem value="3">3</MenuItem><MenuItem value="4">4</MenuItem><MenuItem value="5">5</MenuItem><MenuItem value="6">6</MenuItem><MenuItem value="7">7</MenuItem><MenuItem value="8">8</MenuItem><MenuItem value="9">9</MenuItem><MenuItem value="10">10</MenuItem><MenuItem value="11">11</MenuItem><MenuItem value="12">12</MenuItem>
              </TextField>
            </Grid>
          ))}
        </Grid>
        ...
        <Grid container spacing={3} mb={5}>
          <Grid item xs={12} md={4}>
            ...
            <TextField select fullWidth size="small" value={formData.destination} onChange={(e) => handleChange('destination', e.target.value)}>
              ...
              <MenuItem value="Singapore">Singapore</MenuItem> <MenuItem value="Maldives">Maldives</MenuItem><MenuItem value="Switzerland">Switzerland</MenuItem><MenuItem value="Japan">Japan</MenuItem><MenuItem value="Dubai">Dubai</MenuItem>
            </TextField>
          </Grid>
          <Grid item xs={12} md={4}>
          ...
          <Grid item xs={12} md={4}>
            ...
            <Box sx={{ display: 'flex', gap: 2, alignItems: 'center' }}>
              {/* 🚨 REMOVED readOnly: true and ADDED onChange handlers so you can type manually */}
              <TextField size="small" value={formData.nights} onChange={(e) => handleChange('nights', e.target.value)} placeholder="0" InputProps={{ endAdornment: <InputAdornment position="end">Nights</InputAdornment> }} sx={{ width: '50%', bgcolor: '#f8fafc' }} />
              <TextField size="small" value={formData.days} onChange={(e) => handleChange('days', e.target.value)} placeholder="0" InputProps={{ endAdornment: <InputAdornment position="end">Days</InputAdornment> }} sx={{ width: '50%', bgcolor: '#f8fafc' }} />
            </Box>
          </Grid>
        </Grid>
